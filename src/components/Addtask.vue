<template>
    ...
    <div v-if="!addTask">
        <button @click="onClickToDo" class="button">To do</button>
        <button @click="onClickDone" class="button">Done</button>
    ...
    <div v-if="addTask">
        <form @submit.prevent="onSubmit">
            ...
            <div class="p-2">
                ...
                <textarea v-model="task.description" class="input is-primary" type="text"
    ...
    <div v-else-if="filterbyTodo" class="columns is-multiline is-mobile">
